...
class TrainingDataBuilder
  IN  = "./examples_one_line.jsonl"            # raw scraped + GPT-parsed (you’ll verify/correct these)
  OUT = "./training_data.jsonl"     # what you’ll upload
  ...
  def collect_examples
    File
      ...
      .map { |raw_obj| build_example(raw_obj["input"], raw_obj["output"]) }
  end
